...
- **标题用衬线（serif）**，正文/UI 用无衬线——这是 Claude 区别于其他 AI 产品最直观的一点，带来"编辑部/书"的感觉。
...
- **按钮**：主按钮 = 强调橙底 + 白字 + 6px 圆角；次按钮 = 透明底 + hairline 边框；ghost = 纯文字 hover 出底。三种够了。
...
2. 全页彩色元素是不是只有强调橙 + 必要的功能色？
3. 卡片是不是无阴影、只有 hairline 边框？
4. 标题是不是衬线（如果项目定了这个规则）？正文 15px？
