---
name: learn-codebase
description: Socratic tutor that teaches codebase understanding through questioning, challenges, and active recall. Invoke with /learn-codebase when onboarding to a new codebase or deepening understanding of existing code. Maintains a learning journal that tracks mastery and schedules reviews.
...
2. Copy the contents of `references/JOURNAL-TEMPLATE.md` (bundled with this skill) to `.claude/learning-journal.md` in the project
...
See `references/QUESTION-PATTERNS.md` for detailed examples. Core patterns:
...
- [references/JOURNAL-TEMPLATE.md](references/JOURNAL-TEMPLATE.md) - Template for new learning journals
- [references/QUESTION-PATTERNS.md](references/QUESTION-PATTERNS.md) - Detailed question examples by type
