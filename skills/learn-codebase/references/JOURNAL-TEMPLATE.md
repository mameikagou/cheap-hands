...
<!-- Updated during Interest Discovery -->
- **Primary goal**: [What you want to accomplish with this codebase]
- **Interested in**: [Aspects that genuinely interest you]
- **Background**: [Relevant experience that helps calibrate teaching]
- **Learning style**: [Preferred approach: tracing requests, reading tests, etc.]
