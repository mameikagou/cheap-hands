...
> The user has asked you to install the "knowledge-base-search-skill" skill.
...
2. Check if `$HOME/.claude/skills/knowledge-base-search-skill/` already exists
   - If YES: Ask the user "Skill 'knowledge-base-search-skill' already installed. Overwrite? (y/n)"
   - If NO: Proceed

## Security Declaration

This installation will:
- CREATE directory: `$HOME/.claude/skills/knowledge-base-search-skill/`
- CREATE file: `$HOME/.claude/skills/knowledge-base-search-skill/SKILL.md`
...
Run: `mkdir -p $HOME/.claude/skills/knowledge-base-search-skill`

### Step 2: Write SKILL.md

Write the following content to `$HOME/.claude/skills/knowledge-base-search-skill/SKILL.md`:

```
---
name: knowledge-base-search-skill
description: Use when Codex needs to search a local WorldQuant BRAIN alpha research knowledge base for dataset fields, optimization notes, example ideas, operators, or platform mechanics.
---
...
Read `$HOME/.claude/skills/knowledge-base-search-skill/SKILL.md` and confirm:
...
Tell the user:
"knowledge-base-search-skill installed successfully!
- Location: ~/.claude/skills/knowledge-base-search-skill/
- Trigger: Use when Codex needs to search a local WorldQuant BRAIN alpha research knowledge base for dataset fields, optimization n
- To uninstall: delete the ~/.claude/skills/knowledge-base-search-skill/ directory"

## Rollback

If ANY step fails:
1. Delete the `$HOME/.claude/skills/knowledge-base-search-skill/` directory if it was created
